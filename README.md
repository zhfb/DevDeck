...
**远程与终端**
- SSH 2.0（口令 / 私钥 / Keychain / ssh-agent）、TOTP 二次验证（keyboard-interactive）、PTY 分屏、known_hosts TOFU、keepalive 自动重连
...
- 首次连接 known_hosts TOFU 校验，防中间人攻击
...
│       │                     #   + auto_forward / compose / remote_docker / zmodem / embedded
